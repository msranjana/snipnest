...
export default async function HomePage() {
  ...
  return (
    <div className="flex text-center flex-col h-screen justify-center items-center gap-6">
      <div className="w-full flex xl:flex-row flex-col justify-between items-center xl:gap-0 gap-12">
